<!-- подьягиваем модуль header ; ставить обязательно -->
<?php
    get_header();
?>
        ...
        <div class="mainslider glide">
            <div class="glide__track" data-glide-el="track">
                <ul class="glide__slides">
                    ...
                    <?php
                        // ф-я по выведению постов 
                        // параметры по умолчанию
                        $my_posts = get_posts( array(
                            'numberposts' => -1,                 //кол-во постов, -1 озн высе посты
                            'category_name'    => 'slider',      //как ярлык рубрики
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-7 offset-1">
                                                ...
                                                <!-- динамически выводим заголовок записи -->
                                                <h2 
                                                    style=" 
                                                        <?php 
                                                            //получение значения радиобатон с цветом из админки
                                                ...
                                                <?php 
                                                    //динамически подставляем кнопку слайдера 
                                                    //получение значения радиобатон с on/off из админки
                                                    $field = get_field('slider_btn'); 
                                                    if($field == "on"){
                                                        ?>
                                                            <!-- подставляем url в кнопку -->
                ...
                <div class="row">
                    <div class="col-md-10 offset-md-1 col-lg-5 offset-lg-1">
                        <div class="about__img">
                            ...
                            <!-- 1 вариант: в картинке меняем только src, если в ACF указан URL изображения -->
                            <!-- <img src="<?php the_field('about_img') ?>" alt="про компанию"> -->

                            <!-- 2 вариант: в ACF указан Возвращаемый формат: Массив изображений  -->
                            <?php
                                //записываем массив данный изображения в переменную
                                $image = get_field('about_img');

                                //проверяем есть ли изобрадения в массиве
                                if (!empty($image)): ?>
                                    <!-- усли true заполняеи img -->
                                    <img
                    ...
                    <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 col-xl-5 offset-xl-1">
                        ...
                        <!-- с помощью the_field добавляем пункты из раздела страницы 'about_title'-задаем в ACF->название поля -->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <?php 
                            $img_specialists = get_field('about_specialists__img');
                            if(!empty($img_specialists)): ?>
                            <img class="specialists__img" 
                                src="<?php echo $img_specialists['url'] ?>" 
                                alt="<?php echo $img_specialists['alt'] ?>"
                            >
                        <?php endif; ?>
            ...
            <div class="container">
                ...
                <div class="toys__wrapper">
                    ...
                    <?php
                        ...
                        $my_posts = get_posts( array(
                            'numberposts' => -1,                 //кол-во постов, -1 озн высе посты
                            'category_name'    => 'soft_toys',   //как ярлык рубрики  
                            'orderby'     => 'date',             //сортировка по дате
                            'order'       => 'ASC',              //ASC сортировка в обр порядке
                            'post_type'   => 'post',
                            'suppress_filters' => true,          // подавление работы фильтров изменения SQL запроса
                        ...
                        <!-- вставляем ссылку на превью: the_post_thumbnail_url() -->
                        <div 
                            class="toys__item" 
                            style="background-image: url(<?php 
                                if(has_post_thumbnail()) {
                                    //если превью установлена вставляем на нее ссылку
                                    the_post_thumbnail_url();          
                                } else {
                                    //иначе вствыляем заглушку
                                    echo get_template_directory_uri() . '/assets/img/not-found.jpg'; 
                                }
                            ?>)">

                            <div class="toys__item-info">
                                <!-- the_title() выводит название/заголовок записи -->
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_title1') ?> 
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_descr1') ?> 
                        </div>
                    </div>
                    <div class="col-lg-6">
                        ...
                        <?php 
                            //записываем массив данный изображения в переменную
                            $story_img1 = get_field('story_img1');
                            //проверяем есть ли изобрадения в массиве
                            if(!empty($story_img1)): ?>
                            <!-- усли true заполняеи img -->
                                <img class="aboutus__img" 
                                    src=" <?php echo $story_img1['url']?> "
                                    alt=" <?php echo $story_img1['alt']?> "
                                >
                        <?php endif; ?>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <?php
                            //записываем массив данный изображения в переменную
                            $story_img2 = get_field('story_img2');

                            //проверяем есть ли изобрадения в массиве
                            if (!empty($story_img2)): ?>
                                <!-- усли true заполняеи img -->
                                <img class="aboutus__img"
                                    src="<?php echo $story_img2['url'] ?>"
                                    alt="<?php echo $story_img2['alt'] ?>"
                                />
                        <?php endif; ?>
                    ...
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_title2') ?> 
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_descr2') ?> 
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                            <?php the_field('story_title3') ?> 
                        </div>
                        <div class="aboutus__text">
                            <?php the_field('story_descr3') ?> 
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <?php
                            //записываем массив данный изображения в переменную
                            $story_img3 = get_field('story_img3');

                            //проверяем есть ли изобрадения в массиве
                            if (!empty($story_img3)): ?>
                                <!-- усли true заполняеи img -->
                                <img class="aboutus__img"
                                    src="<?php echo $story_img3['url'] ?>"
                                    alt="<?php echo $story_img3['alt'] ?>"
                                />
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <!-- form меняем на div и оставляем старый класс -->
                        <div class="contacts__feed">
                            <!-- вместо статической формы вставляеи шорткод полученный из плагина Сontact Form 7 при создании формы -->
                            <?php echo do_shortcode('[contact-form-7 id="177" title="Форма отзывов"]') ?>
                        </div>
